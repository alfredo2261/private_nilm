...
def model_pipeline(hyperparameters, train_months, test_month, appliance, window_length, train_buildings,
    ...
    with wandb.init(project="march7_FL_trials", config=hyperparameters):
        ...
        for r in range(100):
            ...
            acc_clients = [test(client.to(device), test_loader, criterion, test_val_seq_std, test_val_seq_mean) for client in client_models]
...
home_ids_train = list(home_ids)[0:20]
...
for i in range(1):
    ...
    testing_homes = [home_ids_train[0]]
