...
global_models = []
best_models = []
training_homes = [3383, 145, 183, 335, 387, 526, 1417, 2358, 4628, 6240,  6526,  6672,  7021,  7069,  7365]

for i in home_ids_train[14:]:
    gc.collect()
    torch.cuda.empty_cache()
    ...
    print(final_results)
    global_model.cpu()
    torch.save(global_model.state_dict(), PATH + "/seq2point_fl_refrigerator_model_3383test_train" + str(len(training_homes)) + "_homes_trial2.pth")